...
def test_available_and_eval_jacobian(build_standard_state):
    ...
    expected_values = {
        ...
        ("speciesCorrectiveMolarVolume", "H+"): 0,
        ("speciesCorrectiveMolarVolume", "H2O"): 0,
        ("speciesCorrectiveMolarVolume", "CO3-2"): 0,
        ("speciesCorrectiveMolarVolume", "CO2"): 0,
        ("speciesCorrectiveMolarVolume", "Ca+2"): 0,
        ("speciesCorrectiveMolarVolume", "Cl-"): 0,
        ("speciesCorrectiveMolarVolume", "HCO3-"): 0,
        ("speciesCorrectiveMolarVolume", "Mg+2"): 0,
        ("speciesCorrectiveMolarVolume", "MgCO3"): 0,
        ("speciesCorrectiveMolarVolume", "MgOH+"): 0,
        ("speciesCorrectiveMolarVolume", "Na+"): 0,
        ("speciesCorrectiveMolarVolume", "OH-"): 0,
        ("speciesCorrectiveMolarVolume", "Calcite"): 0,
