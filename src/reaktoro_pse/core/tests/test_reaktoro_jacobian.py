...
def test_available_and_eval_jacobian(build_standard_state):
    ...
    expected_dict = {
        ...
        ("molarVolume", "AqueousPhase"): True,
        ("molarVolume", "Calcite"): True,
        ("molarVolumeT", "AqueousPhase"): True,
        ("molarVolumeT", "Calcite"): True,
        ("molarVolumeP", "AqueousPhase"): True,
        ("molarVolumeP", "Calcite"): True,
        ("molarVolumeI", "H+"): False,
        ("molarVolumeI", "H2O"): False,
        ("molarVolumeI", "CO3-2"): False,
        ("molarVolumeI", "CO2"): False,
        ("molarVolumeI", "Ca+2"): False,
        ("molarVolumeI", "Cl-"): False,
        ("molarVolumeI", "HCO3-"): False,
        ("molarVolumeI", "Mg+2"): False,
        ("molarVolumeI", "MgCO3"): False,
        ("molarVolumeI", "MgOH+"): False,
        ("molarVolumeI", "Na+"): False,
        ("molarVolumeI", "OH-"): False,
        ("molarVolumeI", "Calcite"): False,
        ("molarGibbsEnergy", "AqueousPhase"): True,
        ("molarGibbsEnergy", "Calcite"): True,
        ("molarEnthalpy", "AqueousPhase"): True,
        ("molarEnthalpy", "Calcite"): True,
        ("molarHeatCapacityConstP", "AqueousPhase"): True,
        ("molarHeatCapacityConstP", "Calcite"): True,
    ...
    expected_values = {
        ...
        ("speciesAmount", "H+"): 4.6148984358727024e-09,
        ("speciesAmount", "H2O"): 49.99900230222967,
        ("speciesAmount", "CO3-2"): 0.0001560702590134032,
        ("speciesAmount", "CO2"): 1.0605907892070936e-05,
        ("speciesAmount", "Ca+2"): 0.0013830621938189114,
        ("speciesAmount", "Cl-"): 0.5,
        ("speciesAmount", "HCO3-"): 0.0019870872475370926,
        ("speciesAmount", "Mg+2"): 0.09976521662129416,
        ("speciesAmount", "MgCO3"): 0.00022929877937776126,
        ("speciesAmount", "MgOH+"): 5.484599328283092e-06,
        ("speciesAmount", "Na+"): 0.5,
        ("speciesAmount", "OH-"): 2.8190788887762645e-06,
        ("speciesAmount", "Calcite"): 0.00861693780618118,
        ("temperature", "AqueousPhase"): 293.15,
        ("temperature", "Calcite"): 293.15,
        ("pressure", "AqueousPhase"): 100000.0,
        ("pressure", "Calcite"): 100000.0,
        ("amount", "AqueousPhase"): 51.10254195153171,
        ("amount", "Calcite"): 0.00861693780618118,
        ("mass", "AqueousPhase"): 0.9326342336003659,
        ("mass", "Calcite"): 0.0008624787836522612,
        ("speciesMoleFraction", "H+"): 9.030663171804076e-11,
        ("speciesMoleFraction", "H2O"): 0.9784053863631931,
        ("speciesMoleFraction", "CO3-2"): 3.0540605819849093e-06,
        ("speciesMoleFraction", "CO2"): 2.0754168945509847e-07,
        ("speciesMoleFraction", "Ca+2"): 2.706445004498365e-05,
        ("speciesMoleFraction", "Cl-"): 0.009784249098102122,
        ("speciesMoleFraction", "HCO3-"): 3.888431321913005e-05,
        ("speciesMoleFraction", "Mg+2"): 0.0019522554614977204,
        ("speciesMoleFraction", "MgCO3"): 4.487032750645556e-06,
        ("speciesMoleFraction", "MgOH+"): 1.0732537206241069e-07,
        ("speciesMoleFraction", "Na+"): 0.009784249098102122,
        ("speciesMoleFraction", "OH-"): 5.5165140149975796e-08,
        ...
        ("molarVolume", "AqueousPhase"): 1.777386800344227e-05,
        ("molarVolume", "Calcite"): 3.6899999999999996e-05,
        ("molarVolumeT", "AqueousPhase"): 0.0,
        ("molarVolumeT", "Calcite"): 0.0,
        ("molarVolumeP", "AqueousPhase"): 0.0,
        ("molarVolumeP", "Calcite"): 0.0,
        ("molarVolumeI", "H+"): 0,
        ("molarVolumeI", "H2O"): 0,
        ("molarVolumeI", "CO3-2"): 0,
        ("molarVolumeI", "CO2"): 0,
        ("molarVolumeI", "Ca+2"): 0,
        ("molarVolumeI", "Cl-"): 0,
        ("molarVolumeI", "HCO3-"): 0,
        ("molarVolumeI", "Mg+2"): 0,
        ("molarVolumeI", "MgCO3"): 0,
        ("molarVolumeI", "MgOH+"): 0,
        ("molarVolumeI", "Na+"): 0,
        ("molarVolumeI", "OH-"): 0,
        ("molarVolumeI", "Calcite"): 0,
        ("molarGibbsEnergy", "AqueousPhase"): -2.347392560568514,
        ("molarGibbsEnergy", "Calcite"): -46945.31451388588,
        ("molarEnthalpy", "AqueousPhase"): -0.5864568549621326,
        ("molarEnthalpy", "Calcite"): 12871.417396603083,
        ("molarHeatCapacityConstP", "AqueousPhase"): 0.011982727553413964,
        ("molarHeatCapacityConstP", "Calcite"): 366.4148868693987,
        ("speciesActivityCoefficientLn", "H+"): -0.33404875184379546,
        ("speciesActivityCoefficientLn", "H2O"): 0.0017399099445603687,
        ("speciesActivityCoefficientLn", "CO3-2"): -2.317470055242518,
        ("speciesActivityCoefficientLn", "CO2"): 0.12990947500233851,
        ("speciesActivityCoefficientLn", "Ca+2"): -1.8033827183433209,
        ("speciesActivityCoefficientLn", "Cl-"): -0.28322083976043094,
        ("speciesActivityCoefficientLn", "HCO3-"): -0.3705321405006836,
        ("speciesActivityCoefficientLn", "Mg+2"): -1.7683993032643284,
        ("speciesActivityCoefficientLn", "MgCO3"): 0.0,
        ("speciesActivityCoefficientLn", "MgOH+"): -0.19142565235586673,
        ("speciesActivityCoefficientLn", "Na+"): -0.5058783324852081,
        ("speciesActivityCoefficientLn", "OH-"): -0.5371313762447514,
        ("speciesActivityCoefficientLn", "Calcite"): 0.0,
        ("speciesActivityLn", "H+"): -19.423532752721222,
        ("speciesActivityLn", "H2O"): -0.0200912794025879,
        ("speciesActivityLn", "CO3-2"): -10.97818235330487,
        ("speciesActivityLn", "CO2"): -11.219697913045016,
        ("speciesActivityLn", "Ca+2"): -8.282345999679404,
        ("speciesActivityLn", "Cl-"): -0.8718760445691756,
        ("speciesActivityLn", "HCO3-"): -6.487125571947716,
        ("speciesActivityLn", "Mg+2"): -3.968843014777595,
        ("speciesActivityLn", "MgCO3"): -8.275992715617804,
        ("speciesActivityLn", "MgOH+"): -12.200500192136529,
        ("speciesActivityLn", "Na+"): -1.0945335372939526,
        ("speciesActivityLn", "OH-"): -13.211739762050415,
        ("speciesActivityLn", "Calcite"): 0.0,
        ("speciesChemicalPotential", "H+"): -47342.61892177661,
        ("speciesChemicalPotential", "H2O"): -48.970174299235026,
        ("speciesChemicalPotential", "CO3-2"): -26758.052215474065,
        ("speciesChemicalPotential", "CO2"): -121394.31988471764,
        ("speciesChemicalPotential", "Ca+2"): -20187.26229841937,
        ("speciesChemicalPotential", "Cl-"): -2125.097213290488,
        ("speciesChemicalPotential", "HCO3-"): -74100.67113724521,
        ("speciesChemicalPotential", "Mg+2"): -9673.59670359897,
        ("speciesChemicalPotential", "MgCO3"): -36431.64891906552,
        ("speciesChemicalPotential", "MgOH+"): 37620.05204387262,
        ("speciesChemicalPotential", "Na+"): -2667.7991492537362,
        ("speciesChemicalPotential", "OH-"): 47293.64874747319,
